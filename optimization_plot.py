...
# 1. Paste your FULL terminal output into a file named 'full_logs.txt'
# 2. Run this script
...
# Run it
try:
    parse_and_plot('full_logs.txt')
except FileNotFoundError:
    print("❌ Please save your terminal output to 'full_logs.txt' first!")
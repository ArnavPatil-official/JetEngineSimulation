...
if __name__ == "__main__":
    # Turbine
    visualize(NormalizedTurbinePINN, "turbine_pinn.pt", "Turbine Expansion", "viz_turbine.png",
              inlet_p=30e5, inlet_T=1600.0, A_in=0.1, m_dot=50.0)

    # Nozzle
    visualize(NozzlePINN, "nozzle_pinn.pt", "Nozzle Acceleration", "viz_nozzle.png",

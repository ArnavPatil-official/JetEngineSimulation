...
print("\nSaved 2D Pareto front visualization to 'pareto_front_2d.png'")
plt.show()
...
print("Saved 3D Pareto front visualization to 'pareto_front_3d.png'")
plt.show()
...
plt.tight_layout()
plt.savefig('pareto_correlations.png', dpi=300, bbox_inches='tight')
print("Saved correlation heatmap to 'pareto_correlations.png'")
plt.show()
...
print("\n" + "="*80)
print(f"Saved {len(pareto_df)} Pareto-optimal solutions to 'pareto_optimal_solutions.csv'")
print("="*80)
